...
class _TherapistListScreenState extends State<TherapistListScreen> {
  final List<Therapists> therapists = [
    Therapists(
        name: 'Ms. Kawira Mukuru',
        email: 'kawira.mukuru@gmail.com',
        location: 'Nairobi, Kenya'),
    Therapists(
        name: 'Hariet Maina',
        email: 'Hariet.maina@gmail.com',
        location: 'Nairobi, Kenya'),
    Therapists(
        name: 'Mr. Tobias Jan',
        email: 'Tobias.jan@gmail.com',
        location: 'Upperhill, Nairobi'),
    Therapists(
        name: 'Mr. Simeon Mainye',
        email: 'Simeon.mainye@gmail.com',
        location: 'Nairobi, Kenya'),
    Therapists(
        name: 'Mr. Husein Allibihai',
        email: 'Husein.allibihai@gmail.com',
